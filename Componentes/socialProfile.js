class SocialProfileComponent extends HTMLElement {
      ...
      shadow.innerHTML = `
        ...
        <div class="profile">
          ...
          <div class="button-group">
                <a href="https://www.instagram.com/brayan.vga/" target="_blank" rel="noopener">Follow</a>
                <a href="https://cdn.memegenerator.es/imagenes/memes/full/22/69/22696724.jpg" target="_blank" rel="noopener">Message</a>
            </div>
        </div>
      `;
    }
  ...
  customElements.define('profile-page', SocialProfileComponent);
